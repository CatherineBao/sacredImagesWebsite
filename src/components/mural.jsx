    ...
    <div>
      {!modalOpenCatalinaCasallas ?
          <div className='w-screen h-full'>
              <div className='fixed absolute z-20 p-20 w-screen h-full bg-background/50' onClick={() => setModalOpenCatalinaCasallas(s => !s)}>
      ...
      {!modalOpenDrewClark ?
          <div className='w-screen h-full'>
              <div className='fixed absolute z-20 p-20 w-screen h-full bg-background/50' onClick={() => setModalOpenDrewClark(s => !s)}>
                <div className='flex items-center justify-center mt-20'>
              <div className='fixed z-30 bg-background w-2/3 h-[80vh] overflow-y-auto lg:mt-[20vh] md:mt-[30vh] mt-[60vh] p-10 rounded-2xl'>
      ...
      {!modalOpenNephiMatagi ?
          <div className='w-screen h-full'>
              <div className='fixed absolute z-20 p-20 w-screen h-full bg-background/50' onClick={() => setModalOpenNephiMatagi(s => !s)}>
                <div className='flex items-center justify-center mt-20'>
              <div className='fixed z-30 bg-background w-2/3 h-[80vh] overflow-y-auto lg:mt-[20vh] md:mt-[30vh] mt-[60vh] p-10 rounded-2xl'>
      ...
      {!modalOpenSpecialEducation ?
          <div className='w-screen h-full'>
              <div className='fixed absolute z-20 p-20 w-screen h-full bg-background/50' onClick={() => setModalOpenSpecialEducation(s => !s)}>
                <div className='flex items-center justify-center mt-20'>
              <div className='fixed z-30 bg-background w-2/3 h-[80vh] overflow-y-auto lg:mt-[20vh] md:mt-[30vh] sm:mt-[40vh] p-10 rounded-2xl'>
