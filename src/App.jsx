          ...
          <div className={backgroundClick} onClick={() => setModalOpenEpilepsy(s => !s)}>
            <div className='flex items-center justify-center mt-20'>
              <div className={modal}>
                ...
                <p className='text-mainText'> The purple ribbon represents epilepsy, which affects some of our students such as Nicolas Neumeyer.  Here is <a className='text-text' href='https://youtu.be/3hkYQSwIgmA' target="_blank" >Nico's story</a> that he wanted to share about epilepsy.</p>
                <div className='p-3 mt-3 md:p-10'>
