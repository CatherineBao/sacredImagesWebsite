...
var EASING_METHODS = {
  linear: tween_esm_default.Easing.Linear.None,
  ease: tween_esm_default.Easing.Quadratic.InOut,
  "ease-in": tween_esm_default.Easing.Quadratic.In,
  "ease-out": tween_esm_default.Easing.Quadratic.Out,
  cubic: tween_esm_default.Easing.Cubic.InOut,
  "cubic-in": tween_esm_default.Easing.Cubic.In,
  "cubic-out": tween_esm_default.Easing.Cubic.Out
};
...
var FadeZoom = import_react.default.forwardRef(function(props, ref) {
  ...
  var tweenGroup = (0, import_react.useRef)(new tween_esm_default.Group());
  ...
  var transitionSlide = function transitionSlide2(newIndex) {
    ...
    if (!existingTweens.length) {
      ...
      animate();
      var tween = new tween_esm_default.Tween(value, tweenGroup.current).to({
        opacity: 1,
        scale: props.scale
